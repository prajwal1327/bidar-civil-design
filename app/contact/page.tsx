      ...
      <main className="space-y-20 py-16">
        <section className="container grid gap-12 lg:grid-cols-[0.9fr_0.9fr] items-center">
          <div className="space-y-6">
            ...
            <p className="max-w-2xl text-sm leading-8 text-slate-300">Our Hatkar team is ready to discuss luxury home designs, commercial projects, approvals and engineering consulting services across Karnataka.</p>
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="glass-card rounded-[2rem] border border-white/10 p-6">
                ...
                <p className="mt-3 text-sm text-slate-300">Head Office on Main Street, Bidar</p>
              </div>
              <div className="glass-card rounded-[2rem] border border-white/10 p-6">
                <p className="text-sm uppercase tracking-[0.3em] text-brand.gold">Reach us</p>
                <p className="mt-3 text-lg font-semibold text-white">+91 97384 17053</p>
                <p className="mt-3 text-sm text-slate-300">contact@hatkarconstruction.com</p>
              </div>
            </div>
          </div>
